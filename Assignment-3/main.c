...
//               performance.
//=============================================================================
void profile(char *dbname, void (*bind)(struct database *db)) {
	struct database db;
	struct profile p;
	...
	printf(
		"Avg Title Search Time        : %10.6lf s\n", p.avg_search_time_title);
	printf(
		"Var Title Search Time        : %10.6lf s\n", p.var_search_time_title);
	printf(
		"Total Title Search Time      : %10.6lf s\n",
	...
	printf(
		"Avg Word Count Search Time   : %10.6lf s\n",
		p.avg_search_time_word_count);
	printf(
		"Var Word Count Search Time   : %10.6lf s\n",
		p.var_search_time_word_count);
	printf(
		"Total Word Count Search Time : %10.6lf s\n",
...
//=== FUNCTION ================================================================
//         Name: main
//  Description: Program entry point - can give the number of books to generate
//  as a parameter
//=============================================================================
